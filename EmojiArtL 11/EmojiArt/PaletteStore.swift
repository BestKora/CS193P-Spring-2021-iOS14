...
//        UserDefaults.standard.set(palettes.map {[$0.name,$0.emojis,String($0.id)]},
//            forKey: userDefaultsKey)
    }
...
//                    let palette = Palette(name: paletteAsArray[0],
//                                          emojis: paletteAsArray[1],
//                                          id: id)
