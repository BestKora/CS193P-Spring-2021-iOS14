...
class EmojiArtDocument: ReferenceFileDocument {
    ...
    func fileWrapper(snapshot: Data, configuration: WriteConfiguration)
                                                 throws -> FileWrapper {
        ...
        case .url(let url):
            ...
            backgroundImageFetchCancellable = publisher
                .sink{[weak self] image in
                        ...
                        self?.backgroundImageFetchStatus
    ...
    private func undoablyPerform(operation: String, with undoManager: UndoManager? = nil,
                                 doit: () -> Void) {
