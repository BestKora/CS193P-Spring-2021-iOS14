...
struct EmojiArtDocumentView: View {
    ...
    var documentBody: some View {
        GeometryReader { geometry in
            ...
            .compactableToolbar {
                AnimatedActionButton(title: "Paste Background",
                ...
                if let undoManager = undoManager  {
                    if undoManager.canUndo {
                        AnimatedActionButton(title: undoManager.undoActionName,
    ...
    private func panGesture() -> some Gesture {
        DragGesture()
            .updating($gesturePanOffset) { latestDragGestureValue,
                                           gesturePanOffset,
                                           _ in
    ...
    private func zoomGesture() -> some Gesture {
        MagnificationGesture()
            .updating($gestureZoomScale){latestGestureScale,
                                         gestureZoomScale,
                                         _ in
